            ...
            <div class="col-md-12 col-12 dashboard-greetings">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="mb-0">Here, you can fill in the form below, click save to complete your registration. When your registration is complete, the buttons to download your ID will be available.</p>
                    </div>
                            ...
                            <div class="d-flex justify-content-between align-items-end">
                                <div class="dashboard-content-left">
                                  ...
                                  @if(auth()->user()->registration_status == 'Pending')  
                                    ...
                                    <a href="{{ route('user.card', auth()->user()->id) }}" class="btn btn-primary glow"> <i class="fa fa-print" aria-hidden="true"></i> View/Print Conference I.D. card
                                    </a>
...
<div class="content-body">
    ...
    <section id="basic-input">
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form action="{{ route('participants.update', auth()->user()->id) }}" onsubmit="return confirm('I am sure all my details are correct and current');" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            ...
                            <input type="number" id="amount" class="form-control @error('amount_paid')is-invalid @enderror" value="{{ auth()->user()->amount_paid }}" disabled required>
                           
                        </fieldset>
                        <fieldset class="form-group">
                            <label for="email">Email</label>
                                <input type="email" id="email" class="form-control @error('email')is-invalid @enderror" value="{{ auth()->user()->email }}" required disabled>						
                        </fieldset>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <fieldset class="form-group">
                            ...
                            <input type="text" id="payment_type"  class="form-control @error('payment_type')is-invalid @enderror" value="{{ auth()->user()->payment_type }}" disabled required>
