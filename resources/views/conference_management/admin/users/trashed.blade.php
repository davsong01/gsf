                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px;padding-right: 5px;">
                                                ...
                                                <a class="actions" data-toggle="tooltip" title="Delete permanently" href="#" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $user->id }}').submit();"> <i class="fa fa-trash"></i></
                                                </a>
