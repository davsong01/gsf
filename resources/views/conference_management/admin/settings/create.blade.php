...
@section('title', 'Update Conference settings')
@section('active')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ config('app.name') }} Conference Settings</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('conferencesettings.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-12">
                                    <p>You can change Conference settings here</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">
                                    <label for="enable_conference">Enable Conference Module</label>
                                    <fieldset class="form-group position-relative has-icon-left">
                                        <select class="form-control" name="enable_conference" id="enable_conference">
                        ...
                        <div class="row" style="background-color:black !important; padding: 20px;">
                            <h2 style="color:red">Caution: use the BUTTON below only if you know what you are doing as this will clear all data from the database!</h2>
                                <a  onclick="return confirm('All conference settings will be lost');" href="{{ route('database.clear') }}" class="btn btn-dark mt-1"><i class="fa fa-warning"></i> Reset application Database</a>
                         </div>
                    </div>
