...
@endsection
@section('active')
<li class="breadcrumb-item">Edit {{ $user->name }}</></li>
@endsection
@section('content2')
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('conference.staff.update', ['id'=>$user->id, 'edition'=>$edition->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')                 
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" placeholder="Enter email" class="form-control" value="{{ old('email') ?? $user->email }}" required>
                                </fieldset>

                                <fieldset class="form-group">
                                    <label for="phone">Phone</label>
                                    <input type="phone" id="phone" placeholder="Enter phone number" name="phone" class="form-control" value="{{ old('phone') ?? $user->phone}}" required>
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-sm-12">                               
                                <fieldset class="form-group">
                                ...
                                <fieldset class="form-group">
                                    ...
                                    <select class="form-control" name="conference_role" id="conference_role" required>
                                        ...
                                        <option value="superadmin" {{$user->conference_role == 'superadmin' ? 'selected' : ''}}>Super Admin</option>
                                        <option value="admin" {{$user->conference_role == 'admin' ? 'selected' : ''}}>Admin</option>
                                    </select>
                                </fieldset>
