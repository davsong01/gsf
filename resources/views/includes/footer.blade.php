        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-copy-right">
                    <p>Copyright &#169; {{  date('Y') }}. All rights reserved.<a href="#">Built by H. Pierson Associates I.T. Team</a>.</p>
...
{{-- </div> --}}
    <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0"><span class="float-left d-inline-block"></span><span class="float-right d-sm-inline-block d-none">&copy; {{ date('Y') }} GSF | Built by<a class="text-uppercase" href="https://techdaves.com/" target="_blank">Techdaves</a></span>
