...
<div class="content-body">
		...
		function PrintElem()
	{
            ...
            var printWindow = window.open('', '', 'height=640,width=480');  
            printWindow.document.write('<html><head><title>Print ID Content</title>');  
								...
								<div class="row">
									<div class="id-card">
										<div class="header">
											...
											<h2 class="name" style="margin-top: 10px; margin-bottom: 10px; font-size:25px">GOFAMINT STUDENTS' FELLOWSHIP
											</h2>
											<h2 class="alias" style="margin-top: 10px; margin-bottom: 10px;">19th Biennial National
												Conference</h2>
											<h3 class="date">{{ $setting->start_date .' to '. $setting->end_date }}</h3><br>
										</div>
										<div class="photo">
										...
										<div>
											...
											<h3 style="font-size:15px" style="font-size:15px">{{ $user->campus->name  }}</h3>
