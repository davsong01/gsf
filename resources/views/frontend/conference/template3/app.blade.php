...
<body class="dark-scheme">
    ...
    <script src="{{ asset('conference_templates/template3/js/countdown-custom.js')}}"></script>
    <script src="{{ asset('conference_templates/template3/js/custom-marquee.js')}}"></script>
