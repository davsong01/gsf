        ...
        <form action="{{ route('student.search') }}" method="POST">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="form-group">                           
                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Type member name... minimum of 4 characters" minlength="4" required>
                </div>
            </div>
