...
@section('title', 'New Payment Provider')
@section('item')
<li class="breadcrumb-item"> <a href="{{ route('paymentproviders.index') }}">Payment Providers</a></li>
@endsection
@section('active')
<li class="breadcrumb-item">Create Payment Provider</li>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form action="{{ route('paymentproviders.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"
                                                value="{{ old('name') }}" placeholder="Enter provider name" required>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="slug" name="slug"
                                                value="{{ old('slug') }}" placeholder="e.g. paystack" required>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="url" class="form-control" id="base_url" name="base_url"
                                                value="{{ old('base_url') }}" placeholder="https://api.provider.com/">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="number" step="0.01" min="0" class="form-control" id="provider_charge" name="provider_charge"
                                                value="{{ old('provider_charge') }}" placeholder="e.g. 50.00">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                                ...
                                                @foreach($options as $val => $label)
                                                    <div class="form-check mr-3 mb-2">
                                                        <input class="form-check-input" type="checkbox" name="channels[]"
                                                            id="{{ $val }}" value="{{ $val }}"
                                                            {{ in_array($val, (array)$channels) ? 'checked' : '' }}>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="api_key" name="api_key"
                                                value="{{ old('api_key') }}" placeholder="API key">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="secret_key" name="secret_key"
                                                value="{{ old('secret_key') }}" placeholder="Secret key">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="public_key" name="public_key"
                                                value="{{ old('public_key') }}" placeholder="Public key">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="customer_pays_provider_charge" name="customer_pays_provider_charge" value="1"
                                                    {{ old('customer_pays_provider_charge') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="customer_pays_provider_charge">
                                                    Customer pays provider charge
                                                </label>
                                            </div>
                                            @error('customer_pays_provider_charge') <small class="text-danger d-block">{{ $message }}</small> @enderror
                                        </fieldset>
                                        <fieldset class="form-group">
                                            <input type="hidden" name="allow_sub_account" value="0">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="allow_sub_account" name="allow_sub_account" value="1"
                                                    {{ old('allow_sub_account') ? 'checked' : '' }}>
                                                <label class="form-check-label" for="allow_sub_account">
                                                    Allow Subaccount
                                                </label>
                                            </div>
                                            @error('allow_sub_account') <small class="text-danger d-block">{{ $message }}</small> @enderror
                                        </fieldset>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (nameInput && slugInput) {
            nameInput.addEventListener('input', function () {
                let slug = this.value.toString().toLowerCase()
