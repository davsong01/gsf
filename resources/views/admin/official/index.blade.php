                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left: 5px;padding-right: 5px;">
                                                <a class="actions" data-toggle="tooltip" title="View/Edit Nec" href="{{ route('choir.edit', $participant->id) }}"> <i class="bx bxs-edit actions"></i></
                                                </a>
                                                
                                                <a class="actions" data-toggle="tooltip" onclick="return confirm('Are you really sure?');" title="Delete Nec" href="{{ route('users.delete', $participant->id) }}"> <i class="fa fa-recycle"></i></
                                                </a>
                                            </td>
                                        </tr>
                                        @endforeach
