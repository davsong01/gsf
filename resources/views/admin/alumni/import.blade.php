				...
				<div class="transition-world-list shadow-reset">
					<div class="sparkline7-list mg-b-40">
						...
						<div class="sparkline7-graph">
							<div class="row">
								<a class="btn btn-primary" href="{{ route('usersexport.sample', 'Alumni') }}"><i class="fa fa-download"></i> Download
									sample</a>
								...
								<form action="{{ route('users.import') }}" method="POST" name="importform" enctype="multipart/form-data"
									...
									<input type="hidden" name="import_level" value="Alumni" required>
									<br>
									@error('file')
