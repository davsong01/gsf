            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('alumni.create') }}" class="btn btn-primary mt-1">Add new Alumni</a>
                                ...
                                <table class="table zero-configuration">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a class="actions" data-toggle="tooltip" title="View/Edit User" href="{{ route('alumni.edit', $participant->id) }}"> <i class="bx bxs-edit actions"></i></
                                            </a>
                                            ...
                                            <a class="actions" data-toggle="tooltip" onclick="return confirm('Are you really sure?');" title="Delete User" href="{{ route('alumni.delete', $participant->id) }}"> <i class="fa fa-trash"></i></
                                            </a>
