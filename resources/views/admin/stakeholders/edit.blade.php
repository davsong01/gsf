                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone') ?? $stakeholder->phone }}" placeholder="Enter phone">
                                    </fieldset>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <fieldset class="form-group">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <select class="form-control" name="day"
                                            ...
                                            <option value="{{ $day}}" {{ $stakeholder->day == $day ? 'selected' : '' }}>{{ $day }}</option>
                                            @endforeach
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <select class="form-control" name="month"
                                            ...
                                            <option value="{{ $value }}" {{ $stakeholder->month == $value ? 'selected' : '' }}>{{ $month }}</option>
                                            @endforeach
                                        </select>
                                    </fieldset>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <select class="form-control" name="role" id="role" required>
                                            ...
                                            <option value="Financial Secretary" {{ $stakeholder->role == 'Financial Secretary' ? 'selected' : ''}}>Financial Secretary</option>
                                            <option value="Portfolio" {{ $stakeholder->role == 'Portfolio' ? 'selected' : ''}}>Portfolio</option>
                                        </select>
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset class="form-group selectfield" style="display:{{ !is_null($stakeholder->field_id) && $stakeholder->role  == 'Field Pastor' ? 'block' : 'none'}}">
                                    ...
                                    <fieldset class="form-group selectzone" style="display:{{ !is_null($stakeholder->zone_id) && $stakeholder->role == 'Zonal Pastor'  ? 'block' : 'none'}}">
                                    ...
                                    <fieldset class="form-group selectportfolio" style="display:{{ $stakeholder->role != 'Portfolio' ? 'none' : 'block'}}">
                                        <label for="portfolio">Portfolio {{ $stakeholder->portfolio }}</label>
                                        <select class="form-control" name="portfolio" id="portfolio">
                                            <option value="">--Select--</option>
                                            @foreach($portfolios as $portfolio)
                                            <option value="{{ $portfolio }}" {{ $stakeholder->portfolio == $portfolio ? 'selected' : ''}}>{{ $portfolio }}</option>
                                            @endforeach
                                        </select>
                                    </fieldset>
                                    <fieldset class="form-group selectchapter" style="display:{{ !is_null($stakeholder->chapter_id) && $stakeholder->role == 'President' ? 'block' : 'none'}}">
                                        <label for="chapter_id">Chapter</label>
                                        <select class="form-control" name="chapter_id" id="chapter_id">
                                            <option value="">--Select--</option>
                                            @foreach($chapters as $chapter)
                                            <option value="{{ $chapter->id }}" {{ $stakeholder->chapter_id == $chapter->id ? 'selected' : ''}}>{{ $chapter->name }}</option>
                                            @endforeach
                                        </select>
                                    </fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <fieldset class="form-group">
                                        ...
                                        <img src="/{{ $stakeholder->signature }}" style="width:70px; height: 40px;" alt=""> <br>
