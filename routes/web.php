...
use App\Http\Controllers\StakeholderSettingController;
...
// Route::get('cron/generate-report-files/{pick?}', [CronController::class, 'generateReportFiles']);
...
Route::middleware(['auth', 'SwitchUser'])->group(function(){
    ...
    Route::controller(AwardController::class)->group(function () {
        ...
        Route::get('shortlist/{shortlist}/download-entries', [AwardShortlistStageController::class, 'downloadEntries'])->name('shortlist.download-entries');
    ...
    Route::post('adjust-award-status/{award}', [AwardController::class, 'adjustAwardStatus'])->name('awards.adjust.status');
    ...
    Route::controller(ConferenceManagementController::class)->group(function () {
        ...
        Route::PATCH('admin-update-conferenceparticipants/{id}/update', 'update')->name('conference.participants.admin.update');
