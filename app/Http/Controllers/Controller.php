...
class Controller extends BaseController
{
    ...
    protected function getDeleteLink($route, $id){
        return sprintf(
                ...
                </form>', $id, route($route, $id), csrf_token(), $id);

    }

    protected function getEditLink($route, $id){
        return sprintf(
            '<a class="actions" data-toggle="tooltip" title="View/Edit User" href="%s" onClick="javascript:editRow(this)"><i class="bx bxs-edit actions"></i></a>', route($route, $id));
    }
}
