...
class User extends Authenticatable implements MustVerifyEmail
{
	 ...
	 */
	protected $hidden = [
		'password', 'remember_token', 'id', 'created_at', 'updated_at', 'deleted_at', 'transid'
	];
	...
	/**
	 * Scope a query to alias certain columns
	 *
	 * @param  \Illuminate\Database\Eloquent\Builder  $query
	 * @param  array|string $from columns to rename
	 * @param  array|string $to alias name
	 * @return \Illuminate\Database\Eloquent\Builder
	 */
	...
	/**
	 * Scope query users to foreign tables set specific columns as new column
	 *
	 * @param  \Illuminate\Database\Eloquent\Builder  $query
	 * @param  array|string $foreignKeys foreign keys on users table
	 * @param  array|string $tables foreign tables
	 * @param  array|string $localKeys local keys on foreign tables
	 * @param  array|string $foreignColumns columns to return on foreign tables
	 * @return \Illuminate\Database\Eloquent\Builder
	 */
