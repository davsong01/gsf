...
class HostelParticipantExport implements WithHeadings, FromQuery
{
	...
	public function query()
	{
		...
		->select('users.family_id', 'transactions.transid', 'users.name', 'users.email', 'users.phone', 'users.gender', 'chapters.name as chapter', 'transactions.created_at as registration_date','transactions.amount_paid','transactions.level','hostels.name as hostel')
