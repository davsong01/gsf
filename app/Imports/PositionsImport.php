...
class PositionsImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
			...
			[
				...
				'position' => 'required|unique:positions,title',
			],
			[
				...
				'position.required' => 'One or more Position do not have a name, please check the position field and try again',
				'position.exists' => 'One or more Positions already exists, please check the position field and try again'
			]
			)->validate();
