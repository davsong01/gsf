                    ...
                    <div class="col-md-6 col-sm-12">
                        <fieldset class="form-group">
                            <label for="name">Name</label>
														<input type="text" class="<?php if ($errors->has('name')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('name'); ?>is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?> form-control" id="name" name="name" value="<?php echo e(old('name') ?? auth()->user()->name); ?>" placeholder="Enter name">
...
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(old('email') ?? auth()->user()->email); ?>" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <fieldset class="form-group">
                            <label for="phone">Phone</label>
														<input type="phone" id="phone" name="phone" class="form-control <?php if ($errors->has('phone')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('phone'); ?>is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(old('phone') ?? auth()->user()->phone); ?>" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                         ...
                         <fieldset class="form-group <?php if ($errors->has('passport')) :
if (isset($message)) { $messageCache = $message; }
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="col-md-6 col-sm-12">
                        <fieldset class="form-group">
                            ...
                            <select class="form-control <?php if ($errors->has('chapter')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('chapter'); ?>is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" name="chapter" id="chapter" required>
...
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <fieldset class="form-group">
                            <label for="amount">Amount Paid</label>
														<input type="number" id="amount" name="amount_paid" class="form-control <?php if ($errors->has('amount_paid')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('amount_paid'); ?>is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(old('amount_paid') ?? auth()->user()->amount_paid); ?>" required>
														<?php if ($errors->has('amount_paid')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('amount_paid'); ?>
														<span class="invalid-feedback" role="alert">
															<strong><?php echo e($message); ?></strong>
														</span>
														<?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
                        ...
                        <fieldset class="form-group">
                            <label for="payment_type">Payment Type</label>
														<input type="text" id="payment_type" name="payment_type" class="form-control <?php if ($errors->has('payment_type')) :
if (isset($message)) { $messageCache = $message; }
$message = $errors->first('payment_type'); ?>is-invalid <?php unset($message);
if (isset($messageCache)) { $message = $messageCache; }
endif; ?>" value="<?php echo e(old('payment_type') ?? auth()->user()->payment_type); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\gsf\resources\views/participant/index.blade.php ENDPATH**/ ?>