<head>
        ...
        <meta property="og:title" content="GSF - 2021 Conference"> 
          <meta property="og:image" content="<?php echo e(asset('frontend/img/logo.png')); ?>"/> 

        <meta property="og:description" content="GSF - 2021 Conference"/>
        <meta property="og:site_name" content="GSF" />

        <!-- Favicon -->
        <link href="<?php echo e(asset('frontend/img/logo.png')); ?>" rel="icon">

        <!-- Google Font -->
        <!-- <link href="https://fonts.googleapis.com/css2?family=Lato&family=Oswald:wght@200;300;400&display=swap" rel="stylesheet"> -->
         <link href="<?php echo e(asset('frontend/css/opensans.css')); ?>" rel="stylesheet">
    ...
    </head><?php /**PATH C:\xampp\htdocs\Laravel Projects\GSF\resources\views/includes/fheader.blade.php ENDPATH**/ ?>