    ...
    <footer class="footer footer-static footer-light">
            <p class="clearfix mb-0"><span class="float-left d-inline-block"></span><span class="float-right d-sm-inline-block d-none">&copy; <?php echo e(date('Y')); ?> GSF | Built by<a class="text-uppercase" href="https://techdaves.com/" target="_blank">Techdaves</a></span>
...
<!-- BEGIN: Vendor JS-->
    ...
    <script src="<?php echo e(asset('app-assets/fonts/LivIconsEvo/js/LivIconsEvo.tools.js')); ?>"></script>
    <script src="<?php echo e(asset('app-assets/fonts/LivIconsEvo/js/LivIconsEvo.defaults.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('app-assets/vendors/js/ui/prism.min')); ?>"></script>
 
    <!-- END: Page Vendor JS-->

    <!-- BEGIN: Theme JS-->
    <script src="<?php echo e(asset('app-assets/js/scripts/configs/vertical-menu-light.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('app-assets/js/scripts/footer.js')); ?>"></script>
    <!-- END: Theme JS-->
    ...
    <!-- END: Page JS-->
    <!-- END: Footer--><?php /**PATH C:\laragon\www\gsf\resources\views/includes/footer.blade.php ENDPATH**/ ?>