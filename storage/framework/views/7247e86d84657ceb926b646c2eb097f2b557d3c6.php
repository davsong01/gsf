 <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div><img style="text-align: center; width:30%; display: block; margin-left: 80px;margin-right: auto;" class="logo" src="<?php echo e(asset('frontend/img/logo.png')); ?>"></div>
        <br><br>
    ...
    </div><?php /**PATH C:\xampp\htdocs\Laravel Projects\GSF\resources\views/includes/main_menu.blade.php ENDPATH**/ ?>