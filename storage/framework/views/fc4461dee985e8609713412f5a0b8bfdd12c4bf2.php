...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('frontend/img/logo.png')); ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('frontend/img/logo.png')); ?>">
...
<!-- END: Head--><?php /**PATH C:\xampp\htdocs\Laravel Projects\GSF\resources\views/includes/head.blade.php ENDPATH**/ ?>