                        ...
                        <div class="card-body pb-1">
                            <div class="d-flex justify-content-around align-items-center flex-wrap">
                                <div class="user-analytics">
                                    ...
                                    <span class="align-middle text-muted"><?php echo e(auth()->user()->slot); ?> Slots avalailable paid</span>
                                    <div class="d-flex">
                                ...
                                <div class="sessions-analytics">
                                    ...
                                    <span class="align-middle text-muted"><?php echo e(auth()->user()->slot_filled); ?> Slots used</span>
                                    <div class="d-flex">
                                ...
                                <div class="sessions-analytics">
                                    ...
                                    <span class="align-middle text-muted"><?php echo e(auth()->user()->slot - auth()->user()->slot_filled); ?> Slots remaining</span>
                                    <div class="d-flex">
                                ...
                                <div class="bounce-rate-analytics">
                                    ...
                                    <span class="align-middle text-muted"><?php echo e($pending_registration->count()); ?> Pending Registration</span>
                                    <div class="d-flex">
                                ...
                                <div class="bounce-rate-analytics">
                                    ...
                                    <span class="align-middle text-muted"><?php echo e($completed_registration->count()); ?> Complete Registration</span>
                                    <div class="d-flex">
                                        <div id="radial-danger-chart"></div>
                                        <h3 class="mt-1 ml-50"></h3>
                                    </div>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel Projects\GSF\resources\views/moderator/index.blade.php ENDPATH**/ ?>